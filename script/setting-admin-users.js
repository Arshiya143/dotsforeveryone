function toggleDropdown(id) {
  ...
  var dropdownButton = document.getElementById(
    id.replace("dropdownOptions-", "dropdownButton-")
  );
...
const tableData = [
  {
    nickname: "Vicky",
    role: "Administrator",
    spaceUsage: "1.1MB/Unlimited",
    group: "Group",
  },
  {
    nickname: "Administrator",
    role: "Administrator",
    spaceUsage: "1.1KB/2GB",
    group: "Group",
  },
  {
    nickname: "Vighnesh",
    role: "User",
    spaceUsage: "1.1KB/4GB",
    group: "Developer",
  },
];
  ...
  function initializeDropdown(dropdown) {
    ...
    button.addEventListener("click", function (event) {
      ...
      customSelect.style.display =
        customSelect.style.display === "block" ? "none" : "block";
    });
...
const toggleButton = document.getElementById("addGroupButon");
const divList = document.getElementById("groupSelection");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  dropdownOptions.forEach((option) => {
    option.addEventListener("click", function (event) {
      ...
      buttonText.innerHTML = `<i class="ri-circle-fill text-yellow-300 pr-2"></i>${selectedText}`;
